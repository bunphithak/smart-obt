...
const SuccessModal = ({ isOpen, onClose, ticketId, reportType, onCheckStatus, title, message }) => {
  if (!isOpen) return null;

  // ถ้ามี title และ message ที่ส่งมา ให้ใช้แบบง่าย
  if (title && message) {
    return (
